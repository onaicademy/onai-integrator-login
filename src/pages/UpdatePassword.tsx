...
/**
 * 🔐 MAIN PLATFORM UPDATE PASSWORD PAGE
 * 
 * ✅ Main Platform Database: Использует supabase
 * ✅ Обновляет пароль только в Main Platform базе
 * ✅ НЕ затрагивает Tripwire пользователей
 */
...
export default function UpdatePassword() {
  ...
  useEffect(() => {
    ...
    const checkSession = async () => {
      // Wait a bit for Supabase to process hash params
  ...
  const onSubmit = async (data: UpdatePasswordFormData) => {
    ...
    try {
      ...
      // Update password in Main Platform Supabase
  ...
  return (
    <div className="relative min-h-screen overflow-hidden flex flex-col items-center justify-center bg-black">
