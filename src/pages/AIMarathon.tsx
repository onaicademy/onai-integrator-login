...
import HeroSectionFigma from "@/components/aimarathon/HeroSectionFigma";
import StickyHeader from "@/components/aimarathon/StickyHeader";
import ProgramSectionNew from "@/components/aimarathon/ProgramSectionNew";
...
const AIMarathon = () => {
  ...
  return (
    <div className="relative bg-black text-white overflow-x-hidden">
      ...
      <motion.div
        className="fixed top-0 left-0 right-0 h-1 bg-[#b2ff2e] z-50"
      ...
      {/* Sticky Header */}
      <StickyHeader onOpenModal={() => setIsModalOpen(true)} spotsLeft={spotsLeft} />
      
      {/* Main Content */}
      <main className="relative z-10">
        {/* Hero Section */}
        <HeroSectionFigma onOpenModal={() => setIsModalOpen(true)} />
        
        <ProgramSectionNew onOpenModal={() => setIsModalOpen(true)} />
        <TrustSection />
        <CasesSection />
