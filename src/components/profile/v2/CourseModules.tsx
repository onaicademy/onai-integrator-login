  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <h3 className="text-xl font-bold text-foreground">Курсы</h3>
        <span className="text-xs text-muted-foreground">{modules.length} модулей</span>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {modules.map((module, index) => {
          ...
          return (
            ...
            >
              <div className="relative bg-[#1B1B1B]/80 backdrop-blur-md border border-border/50 rounded-2xl p-5 overflow-hidden transition-all duration-500 hover:border-neon/50">
                ...
                <div className="relative z-10 space-y-4">
                  ...
                  <div className="flex items-start justify-between">
                    <div className="p-3 rounded-xl bg-gradient-to-br from-neon/20 to-neon/5 border border-neon/30 group-hover:border-neon/50 transition-colors">
                      <Icon className="w-6 h-6 text-neon" />
                    </div>
                    <div className="text-right">
                      <p className="text-2xl font-bold text-neon">{module.progress}%</p>
                  ...
                  <Button
                    variant="outline"
                    className="w-full border-neon/40 hover:bg-neon/10 hover:border-neon group/btn transition-all duration-300"
                  >
