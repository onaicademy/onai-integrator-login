...
export function OnAILogo({ className = "", variant = 'full' }: OnAILogoProps) {
  ...
  if (variant === 'icon') {
    // Только иконка O для collapsed sidebar - с анимацией включения
    return (
      <motion.svg
        width="40"
        height="40"
      ...
      >
        ...
        {/* Внутренний круг - toggle button (движется слева направо и меняет цвет) */}
        <motion.circle
          initial={{ cx: 135.597 }}
          animate={{
        ...
        {/* Свечение при включении - iPhone style pulse (БЕЗ постоянного свечения) */}
        {isOn && (
          <>
            {/* Первая волна пульсации */}
            <motion.circle
              cx="361.592"
              cy="137.905"
              r="100"
            ...
            {/* Вторая волна пульсации (задержка) */}
            <motion.circle
              cx="361.592"
              cy="137.905"
              r="100"
  ...
  // Полный логотип - O с анимацией включения, остальное белое
  return (
    <motion.svg
