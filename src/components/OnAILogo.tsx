...
export function OnAILogo({ className = "", variant = 'full' }: OnAILogoProps) {
  const [mounted, setMounted] = useState(false);

  useEffect(() => {
    // Плавная анимация после монтирования
  ...
  if (variant === 'icon') {
    // Только иконка O для collapsed sidebar
    return (
      <motion.svg 
        width="40" 
        height="40" 
      ...
      >
        ...
        <motion.path
          d="M542.885 298.274H316.889C266.945 298.274 226.491 339.415 226.491 390.211C226.491 441.006 266.945 482.148 316.889 482.148H542.885C592.829 482.148 633.283 441.006 633.283 390.211C633.283 339.415 592.829 298.274 542.885 298.274Z"
          initial={{ fill: "rgba(255, 255, 255, 0)", opacity: 0 }}
          animate={{ 
            fill: mounted ? "#B1FF32" : "rgba(255, 255, 255, 0)",
            opacity: mounted ? 1 : 0
          }}
          transition={{ 
            fill: { delay: 1.0, duration: 0.8, ease: [0.42, 0, 0.58, 1] },
            opacity: { delay: 1.0, duration: 0.8, ease: [0.42, 0, 0.58, 1] }
          }}
        />
        
        {/* Круглая кнопка toggle (движется слева направо, остается белой) */}
        <motion.circle
          cx="316.889"
          cy="390.211"
          r="68.953"
          initial={{ fill: "white", opacity: 0 }}
          animate={{ 
            cx: mounted ? 542.885 : 316.889,
            fill: "white",
            opacity: 1
          }}
          transition={{ 
            cx: { delay: 1.0, duration: 0.8, ease: [0.42, 0, 0.58, 1] },
            opacity: { duration: 0.6, ease: "easeOut" }
          }}
        />
        
        {/* Свечение при включении */}
        <motion.circle
          cx="542.885"
          cy="390.211"
          r="100"
          ...
          animate={{ 
            opacity: mounted ? [0, 0.4, 0] : 0,
            scale: mounted ? [0.5, 1.3, 1.5] : 0.5
          }}
          transition={{ 
            delay: 1.2,
            duration: 0.8,
  ...
  return (
    ...
    >
      ...
      <motion.path 
        ...
        transition={{ 
          fill: { delay: 1.2, duration: 0.8, ease: [0.25, 0.46, 0.45, 0.94] },
          opacity: { duration: 0.6, ease: "easeOut" }
        }}
      />
      ...
      {/* Разделитель */}
      <motion.path 
        d="M2015.73 153.979L2015.73 531.927" 
        stroke="white" 
        strokeWidth="15.6024"
