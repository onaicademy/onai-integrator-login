      ...
      >
        ...
        {[...Array(12)].map((_, i) => {
          ...
          return (
            <motion.div
              key={i}
              className="absolute text-[#b2ff2e] font-mono text-xs xl:text-sm opacity-60"
              style={{
                left: "50%",
                top: "50%",
        ...
        >
          <div className="relative">
            ...
            {/* AI текст в центре */}
            <motion.div
              className="relative text-3xl xs:text-4xl sm:text-5xl md:text-6xl xl:text-8xl font-black text-[#b2ff2e]"
              style={{
                textShadow:
        ...
        {[...Array(8)].map((_, i) => {
          ...
          return (
            <motion.div
              key={`particle-${i}`}
              className="absolute w-2 h-2 bg-[#b2ff2e] rounded-full"
              style={{
                left: "50%",
                top: "50%",
