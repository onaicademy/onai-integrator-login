...
echo "   • http://localhost:8080/integrator/expresscourse"
echo "   • http://localhost:8080/integrator/proftest/muha"
echo "   • http://localhost:8080/integrator/proftest/arystan"
echo "   • http://localhost:8080/integrator/proftest/kenesary"
echo ""
echo "📝 Логи:"
