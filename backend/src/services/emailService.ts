...
/**
 * Отправляет приветственное письмо новому пользователю Tripwire
 */
...
<body style="margin: 0; padding: 0; background-color: #030303; font-family: Helvetica, Arial, sans-serif; color: #FFFFFF; line-height: 1.7;">
  <table role="presentation" width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#030303" style="background-color:#030303;">
    <tr>
      <td align="center" style="padding: 40px 0;">
        <table role="presentation" width="600" border="0" cellspacing="0" cellpadding="0" style="width:600px; max-width: 600px; margin: 0 auto; background-color: #0A0A0A; border: 1px solid #1F1F1F; border-radius: 16px; overflow: hidden; color: #E0E0E0;">
          <tr>
            <td style="padding: 0;">
              
              <!-- HEADER -->
              <table role="presentation" width="100%" border="0" cellspacing="0" cellpadding="0" style="background-color: #000000; border-bottom: 1px solid #1F1F1F;">
                <tr>
                  <td align="center" style="padding: 30px 40px; font-family: Helvetica, Arial, sans-serif; font-size: 32px; font-weight: 800; line-height: 1.2;">
                    <span style="color: #00FF94;">on</span><span style="color: #FFFFFF;">AI Academy</span>
                  </td>
                </tr>
              </table>

              <!-- CONTENT -->
              <table role="presentation" width="100%" border="0" cellspacing="0" cellpadding="0" style="padding: 40px; color: #E0E0E0; line-height: 1.7; font-size: 16px; text-align: center;">
                <tr>
                  <td align="center" style="font-family: Helvetica, Arial, sans-serif; font-size: 16px; color: #E0E0E0;">
                    
                    <!-- GREETING -->
                    <div style="color: #FFFFFF; font-size: 26px; margin-bottom: 15px; font-weight: 700; text-transform: uppercase; line-height: 1.2;">
                      ПОЗДРАВЛЯЕМ, ${params.name}!
                    </div>
                    ...
                    <!-- FEATURE LIST -->
                    <table role="presentation" border="0" cellspacing="0" cellpadding="0" align="center" style="margin: 10px 0 25px 0; max-width: 90%;">
                      <tr>
                        <td align="left">
                          <table role="presentation" border="0" cellspacing="0" cellpadding="0" style="width:100%; margin-bottom: 14px;">
                            <tr>
                              <td width="24" valign="top" style="color: #00FF94; font-size: 20px; font-weight: bold;">✓</td>
                              <td valign="top" style="padding-left: 15px; font-weight: 600; color: #E0E0E0; font-size: 15px;">
                    ...
                    <!-- HIGHLIGHT LINE -->
                    <p style="text-align: center; color: #00FF94; font-weight: 700; font-size: 16px; text-transform: uppercase; margin-bottom: 35px; line-height: 1.2;">
                      ⚡ ДОСТУП АКТИВИРОВАН. ВРЕМЯ ДЕЙСТВОВАТЬ.
                    </p>

                    <!-- CREDENTIALS BOX -->
                    <table role="presentation" width="100%" border="0" cellspacing="0" cellpadding="0" style="margin: 35px 0; border-radius: 12px; border: 1px solid #2A2A2A; background-color: #0F0F0F;">
                      <tr>
                        <td align="center" style="padding: 30px 25px; font-family: Arial, sans-serif;">
                          
                          <!-- LOGIN -->
                          <div style="color: #888888; font-size: 13px; font-weight: 400; margin-bottom: 6px;">
                            Ваш логин:
                          </div>
                          <div style="display: block; margin-bottom: 20px;">
                            <span style="color: #00FF94; font-size: 20px; font-weight: 500; line-height: 1.2; background-color: #020806; padding: 8px 12px; border-radius: 6px; border: 1px solid #163428; display: inline-block;">
                              ${params.toEmail}
                            </span>
                          </div>
                          ...
                          <div style="display: block; margin-bottom: 20px;">
                            <span style="color: #00FF94; font-size: 20px; font-weight: 500; line-height: 1.2; background-color: #020806; padding: 8px 12px; border-radius: 6px; border: 1px solid #163428; display: inline-block; font-family: 'Courier New', Courier, monospace;">
                              ${params.password}
                            </span>
                          </div>

                          <p style="text-align: center; margin-top: 25px; margin-bottom: 0;">
                            <span style="display: block; margin-top: 12px; font-size: 11px; color: #666666;">
                    ...
                    <!-- CTA BUTTON -->
                    <table role="presentation" width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top: 35px; margin-bottom: 20px;">
                      <tr>
                        <td align="center">
                          <table role="presentation" border="0" cellspacing="0" cellpadding="0" style="background-color: #00FF94; border-radius: 6px;">
                            <tr>
                              <td align="center" style="padding: 18px 45px;">
                                <a href="https://expresscourse.onai.academy/login?email=${encodeURIComponent(params.toEmail)}" style="color: #000000; font-family: Helvetica, Arial, sans-serif; font-size: 16px; font-weight: 800; text-transform: uppercase; letter-spacing: 1px; text-decoration: none; display: inline-block;">
                                  ВОЙТИ В ПЛАТФОРМУ
                                </a>
                              </td>
                            </tr>
              ...
              <!-- FOOTER -->
              <table role="presentation" width="100%" border="0" cellspacing="0" cellpadding="0" style="padding: 30px; text-align: center; font-size: 12px; color: #555555; border-top: 1px solid #1F1F1F;">
                <tr>
                  <td align="center" style="font-family: Arial, sans-serif; font-size: 12px; color: #555555;">
                    <p style="margin: 0; padding-bottom: 5px;">onAI Academy — Интегратор 3.0</p>
                    <p style="margin: 0;">&copy; 2025 Все права защищены.</p>
                    <p style="font-size: 10px; color: #555555; margin-top: 10px;">
    ...
    // ВАЖНО: Домен должен быть верифицирован в Resend Dashboard
...
<head>
  <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>Обновление данных безопасности</title>
  <style>
...
<path d="M537.318 317.975C500.188 317.975 470.215 348.458 470.215 386.22C470.215 423.982 500.188 454.465 537.318 454.465C574.448 454.465 604.421 423.982 604.421 386.22C604.421 348.458 574.448 317.975 537.318 317.975Z" fill="#2EE57C"/>
          ...
          <div class="content">
            <div class="h1">🔐 ОБНОВЛЕНИЕ ДАННЫХ БЕЗОПАСНОСТИ</div>
            
            <div class="alert-box">
              <p style="margin: 0; font-size: 18px; color: #FFC107; font-weight: 600;">
                ⚠️ SECURITY ALERT: EMAIL ИЗМЕНЕН
              </p>
            </div>

            <p style="margin-bottom: 25px; text-align: left;">
              Уважаемый <strong style="color: #00FF94;">${params.name}</strong>,
            </p>
            
            <p style="text-align: left; margin-bottom: 30px; font-size: 16px; line-height: 1.8;">
              Ваш email адрес для входа в платформу <strong>onAI Academy</strong> был успешно изменен.
            </p>

            <div class="info-box">
              <div style="margin-bottom: 15px;">
                <div class="label">СТАРЫЙ АДРЕС:</div>
            ...
            <div style="background-color: rgba(220, 38, 38, 0.15); border-left: 4px solid #DC2626; padding: 25px; margin-top: 35px; text-align: left; border-radius: 8px;">
              ...
              <p style="margin: 10px 0 0 0; font-size: 15px; color: #E0E0E0; line-height: 1.6;">
                Если это сделали <strong>не вы</strong> — срочно свяжитесь с администратором или поддержкой по адресу 
          ...
          <div class="footer">
            <p style="margin: 0; padding-bottom: 5px;">onAI Academy — Интегратор 3.0</p>
            <p style="margin: 0;">&copy; 2025 Все права защищены.</p>
            <p style="margin-top: 10px; opacity: 0.7;">Это автоматическое письмо.</p>
          </div>
        </div>
      </td>
    </tr>
...
<path d="M537.318 317.975C500.188 317.975 470.215 348.458 470.215 386.22C470.215 423.982 500.188 454.465 537.318 454.465C574.448 454.465 604.421 423.982 604.421 386.22C604.421 348.458 574.448 317.975 537.318 317.975Z" fill="#2EE57C"/>
          ...
          <div class="content">
            ...
            <p style="text-align: left; margin-bottom: 30px; font-size: 16px; line-height: 1.8;">
              Ваш пароль для входа в платформу <strong>onAI Academy</strong> был успешно изменен.
            </p>
