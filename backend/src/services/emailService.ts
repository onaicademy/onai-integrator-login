...
<path d="M537.318 317.975C500.188 317.975 470.215 348.458 470.215 386.22C470.215 423.982 500.188 454.465 537.318 454.465C574.448 454.465 604.421 423.982 604.421 386.22C604.421 348.458 574.448 317.975 537.318 317.975Z" fill="#2EE57C"/>
          ...
          <div class="content">
            <div class="h1">ПОЗДРАВЛЯЕМ, ${params.name}!</div>
            ...
            <div class="feature-list-wrapper">
                <ul class="feature-list">
                  <li><span class="icon">✓</span><span>Освоите базовые AI-инструменты на практике</span></li>
                  <li><span class="icon">✓</span><span>Поймёте, как это работает в реальных проектах</span></li>
                  <li><span class="icon">✓</span><span>Подготовитесь к полному курсу</span></li>
                </ul>
            </div>
