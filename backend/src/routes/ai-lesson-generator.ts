...
ВАЖНЫЕ ТРЕБОВАНИЯ:
- ⚠️ ОПИСАНИЕ: СТРОГО от 200 до 230 символов (НЕ МЕНЬШЕ 200!)
- Описание тезисное: Узнаем... Научимся... Получим...
- Советы конкретные и практические
- Простой язык для студента
- Формат ответа - ТОЛЬКО JSON

ФОРМАТ ОТВЕТА:
{
  "description": "Узнаем... Научимся... Получим... (200-230 символов)",
  "tips": "Совет 1: ...\\nСовет 2: ...\\nСовет 3: ..."
}`;
