-- Migration 014: Core Data Tables for Traffic Dashboard (ADAPTED)
...
CREATE TABLE IF NOT EXISTS public.challenge3d_sales (
  ...
  -- Prepayment linkage
  prepayment_deal_id BIGINT, -- Link to original prepayment deal
...
-- ============================================================================
-- 6. RECREATE UTM Analytics Views (based on existing all_sales_tracking table)
-- ============================================================================

-- Note: all_sales_tracking already exists as a TABLE (not a view)
-- Creating enhanced views based on existing table
...
SELECT
  ...
  utm_campaign,
  utm_medium,
  product_name as funnel_type,
  COUNT(*) as sales_count,
  SUM(sale_amount) as total_revenue,
  AVG(sale_amount) as avg_sale
FROM all_sales_tracking
WHERE sale_date >= CURRENT_DATE - INTERVAL '90 days'
GROUP BY DATE(sale_date), utm_source, utm_campaign, utm_medium, product_name
...
-- ============================================================================
-- 
-- traffic_leads: 0 rows
-- traffic_sales: 0 rows
-- challenge3d_sales: 0 rows
-- facebook_ad_spend: 0 rows
-- top_utm_sources: 0 rows
-- top_utm_campaigns: 0 rows
-- sales_without_utm: 0 rows
-- daily_utm_stats: 0 rows
-- utm_source_by_team: 0 rows
-- 
-- ============================================================================
